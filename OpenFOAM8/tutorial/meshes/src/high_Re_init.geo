...
Point(5)  = {0,           -0.5, h_blayer, 1.0};
Point(6)  = {X_bed,       -0.5, h_blayer, 1.0};
Point(7)  = {X_bed+L_bed, -0.5, h_blayer, 1.0};
Point(8)  = {L,           -0.5, h_blayer, 1.0};

Point(9)  = {0,           -0.5, H-h_blayer, 1.0};
Point(10) = {X_bed,       -0.5, H-h_blayer, 1.0};
Point(11) = {X_bed+L_bed, -0.5, H-h_blayer, 1.0};
Point(12) = {L,           -0.5, H-h_blayer, 1.0};

Point(13) = {0,           -0.5, H, 1.0};
Point(14) = {L,           -0.5, H, 1.0};
Point(15) = {X_bed,       -0.5, H, 1.0};
Point(26) = {X_bed+L_bed, -0.5, H, 1.0};
...
Transfinite Curve {5, 6, 7, 8}    = (L_bed/h_blayer)*(nz_blayer/ratio_cnt)Using Progression 1.009;
